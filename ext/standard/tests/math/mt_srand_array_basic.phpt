...
echo "Seed = array with integral floats. Expected: NULL, true:\n";
test_seed([1.0, 2.0, 3.0, 1.0e9]);

echo "Seed = array with integral strings. Expected: warning, NULL, false:\n";
test_seed(['1', '+2', '-3']);
...
echo "Seed = array with non well formed numeric string. Expected: warning, NULL, false:\n";
test_seed(['123xyz']);
...
NULL
bool(true)
Seed = array with integral floats. Expected: NULL, true:
NULL
bool(true)
Seed = array with integral strings. Expected: warning, NULL, false:
...
NULL
bool(false)
Seed = array with non well formed numeric string. Expected: warning, NULL, false:
